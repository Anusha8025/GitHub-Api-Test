...
import com.test.webservice.models.response.OwnerPOJO;
import com.test.webservice.models.response.PermissionPOJO;
import com.test.webservice.models.response.LicensePOJO;
...
public class GetAllRepoPOJO {
	...
	private List<OwnerPOJO> ownerlist;
	...
	private String has_discussions;
	...
	//private String license;LicensePOJO
	private List<LicensePOJO> licenselist;
	private String allow_forking;
	private String is_template;
	private String web_commit_signoff_required;
	private List topics;
	...
	public List<OwnerPOJO> getOwnerlist() {
		return ownerlist;
	}
	public void setOwnerlist(List<OwnerPOJO> ownerlist) {
	...
	public String getHas_discussions() {
		return has_discussions;
	}
	public void setHas_discussions(String has_discussions) {
	...
	public String getAllow_forking() {
		return allow_forking;
	}
	public void setAllow_forking(String allow_forking) {
	...
	public String getWeb_commit_signoff_required() {
		return web_commit_signoff_required;
	}
	public void setWeb_commit_signoff_required(String web_commit_signoff_required) {
	...
	public SingleRepoResponsePOJO jasonpath() {
